...
class LoadJobData extends AbstractFixture implements OrderedFixtureInterface {
    ...
    public function load(ObjectManager $em) {
        ...
        $job_sensio_labs->setCategory($this->getReference('category-programming'));
        ...
        $job_sensio_labs->setDescription('You\'ve alreadypeof 3 yeao d frameworks available.');
        ...
        $job_sensio_labs->setCreatedAt(new \DateTime("now"));

        $job_extreme_sensio = new Job();
        $job_extreme_sensio->setCategory($this->getReference('category-design'));
        ...
        $job_extreme_sensio->setDescription('Lorem ipsum dolor ure dolor in reprehenderit in.');
        ...
        $job_extreme_sensio->setCreatedAt(new \DateTime("now"));
